...
def head_resnet101(num_classes=21, output_stride=8, pretrained_backbone=True):
    """Constructs a DoubleAttention model with a ResNet-101 backbone.
       ...
       Args:
           ...
           pretrained_backbone (bool): If True, use the pretrained backbone.
       """
    return _load_model('head','resnet101',num_classes,  output_stride=output_stride, pretrained_backbone=pretrained_backbone)
...
def head_resnet50(num_classes=21, output_stride=8, pretrained_backbone=True):
    """Constructs a DoubleAttention model with a ResNet-101 backbone.
       ...
       Args:
           ...
           pretrained_backbone (bool): If True, use the pretrained backbone.
       """
    return _load_model('head','resnet50',num_classes,  output_stride=output_stride, pretrained_backbone=pretrained_backbone)